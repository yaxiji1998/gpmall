...
<%@ page import="cn.edu.ywb.pojo.Good" %>
...
<%
    ...
    Good gg = null;
    List<Good> allGood = (List<Good>) session.getAttribute("allGood");
    for (Good g :
            allGood) {
        if(g.getId()==id){
            gg=g;
...
<script>
    ...
    function addToWishList(){
        if(${sessionScope.user==null}){
            ...
            formData.append('gid', gid);
            $.ajax({
                url: "/gpmall/focus/addToWishList.do",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="product-large-slider">
                                        <div class="pro-large-img img-zoom">
                                            <img src="<%=gg.getGpicture()%>" alt="product-details" />
                                        </div>
                                        <div class="pro-large-img img-zoom">
                                            <img src="<%=gg.getGpicture()%>" alt="product-details" />
                                        </div>
                                ...
                                <div class="col-lg-7">
                                    <div class="product-details-des">
                                        <h3 class="product-name"><%=gg.getGname()%></h3>
                                        ...
                                        <div class="price-box">
                                            <span class="price-regular"><%=gg.getGrprice()%></span>
                                            <span class="price-old"><del><%=gg.getGoprice()%></del></span>
                                        </div>
                                        <h5 class="offer-text"><strong>Hurry up</strong>! offer ends in:</h5>
                                        <div class="product-countdown" data-countdown="2020/07/25"></div>
                                        <div class="availability">
                                            <i class="fa fa-check-circle"></i>
                                            <span>库存<%=gg.getGstore()%></span>
                                        </div>
                                        <p class="pro-desc">欢迎光临本店购物，本店为您提供种类丰富的商品供您挑选</p>
                                        <div class="quantity-cart-box d-flex align-items-center">
                                            <h5>数量:</h5>
                                            <div class="quantity">
                                                <div class="pro-qty"><input id="shoppingNumber" type="number" min="0" value="1"></div>
                                            </div>
                                            <div class="action_link">
                                                <button class="btn btn-cart2" onclick="addToCart()">加入购物车</button>
                                            </div>
                                        </div>
                                        <div class="pro-size">
                                            <h5>size :</h5>
                                        ...
                                        <div class="useful-links">
                                            ...
                                            <button data-toggle="tooltip" title="Wishlist" onclick="addToWishList()"><i
                                                    class="lnr lnr-heart"></i>加入愿望清单</button>
                                        </div>
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    ...
                                    <div class="button-group">
                                        <a href="wishlist.jsp" data-toggle="tooltip" data-placement="left" title="Add to wishlist"><i class="lnr lnr-heart"></i></a>
                                        ...
                                        <a href="cart.jsp" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="lnr lnr-cart"></i></a>
                                    </div>
                                </figure>
